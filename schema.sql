...
-- Dropar tabelas se existirem (apenas para desenvolvimento)
...
CREATE TABLE produtos (
    ...
    -- Foreign Keys
    CONSTRAINT FK_produtos_estoque_usuario_criacao
        FOREIGN KEY (usuario_criacao_id) REFERENCES supply_chain.usuarios(id),
    CONSTRAINT FK_produtos_estoque_usuario_atualizacao
        FOREIGN KEY (usuario_atualizacao_id) REFERENCES supply_chain.usuarios(id),
...
-- ============================================================================
-- Trigger para atualização da tabela de usuários
...
-- Trigger para atualização da tabela de produtos
